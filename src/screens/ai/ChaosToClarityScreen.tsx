...
const ChaosToClarityScreen: React.FC<ChaosToClarityScreenProps> = ({
  ...
  const lastScanResults = [
    { id: 1, icon: '📅', text: 'Dentist Tuesday', color: '#EC4899' },
    { id: 2, icon: '💡', text: 'Project idea', color: '#9F7AEA' },
    { id: 3, icon: '🛒', text: 'Buy milk', color: '#F59E0B' },
    { id: 4, icon: '📞', text: 'Call mom', color: '#10B981' },
    { id: 5, icon: '✍️', text: 'Write report', color: '#06B6D4' },
  ];
                ...
                <NebulaCard
                  ...
                  <View
                    ...
                    <View
                      ...
                      <NebulaText size="2xl" style={{ opacity: 0.8 }}>
                        {isScanning ? '🔍' : '📸'}
                      </NebulaText>
                    </View>
                    <NebulaText
                  ...
                  {lastScanResults.map((result, index) => (
                    <NebulaAnimated
                      ...
                      <View
                        ...
                        <NebulaText size="sm" style={{ marginRight: 6 }}>
                          {result.icon}
                        </NebulaText>
